...
def score_one(record: Dict[str, Any], analysis: Optional[Dict[str, Any]],
    ...
    return jsonable({
        ...
        "llm": {
            ...
            "centralityRationale": analysis.get("centralityRationale"),
            "expansionRationale": analysis.get("expansionRationale"),
            "diversityRationale": analysis.get("diversityRationale"),
