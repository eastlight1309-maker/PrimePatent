...
FIELDS: List[FieldSpec] = [
    ...
    _f("externalTr", "외부TR", FLOAT,
       ["외부TR", "외부 TR", "외부TR수", "External TR", "EXTERNAL TR"], "텍스트",
       important=True, note="경쟁사 커버리지 산출에 사용(모집단 최대값 대비 비율 × 7점)"),
    _f("totalTr", "TR", FLOAT,
       ["TR", "TR수", "총TR", "Total TR", "TOTAL TR"], "텍스트",
       important=True, note="연령보정 피인용 영향력 산출에 사용(모집단 최대값 대비 비율 × 13점)"),
    ...
    _f("otherForwardCitations", "타인 피인용 문헌번호(F1)", LIST, ["타인 피인용 문헌번호(F1)"], "인용",
       note="자기/타인 피인용 구분 참고용(점수 산출에는 사용하지 않음)"),
